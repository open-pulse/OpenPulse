...
start = time()
# Fluid setup
sound_velocity = 350.333#343.21
density = 24.85#1.2041
...
if run==1:
    ...
    mesh.set_specific_impedance_BC_by_node(1086, 343 * 1.2)
...
if run==2:
    ...
    # Anechoic termination
    mesh.set_specific_impedance_BC_by_node(1047, 343 * 1.2)
    # Rigid termination on nodes
