...
def anima(coordinates, connectivity, eigvects, mode, scf = 0.4, Undeformed = True, Deformed = False, Animate_Mode = True, Save = False):
    ...
    connectivity = np.array(connectivity[:,-2:],int) ## Substituir no código final;
