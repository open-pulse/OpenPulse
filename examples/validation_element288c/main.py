...
if run==1:
    file1 = open("examples/validation_element288c/" + test_label + "/FRF_Fx_1N_Ux_node_436.csv", "r")
    FRF = np.loadtxt(file1, delimiter=",", skiprows=2)
    file1.close()
elif run==2:
    file2 = open("examples/validation_element288c/" + test_label + "/FRF_Fx_1N_Uy_node_187.csv", "r")
    FRF = np.loadtxt(file2, delimiter=",", skiprows=2)
    file2.close()
elif run==3:
    file3 = open("examples/validation_element288c/" + test_label + "/FRF_Fx_1N_Uz_node_711.csv", "r")
