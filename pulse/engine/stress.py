...
for el in range(nel):
    ...
    #
    n1 = connect[el-1,1]
    a[n1-1] = 1 #IMPLEMENTAR: Aqui o 'a' seria um vetor. Vai armazendo quantas vezes cada nó é chamado! Para a média nodal. Deixei 1 de bobeira.
    n2 = connect[el-1,2]
    a[n2-1] = 1 #IMPLEMENTAR: Aqui o 'a' seria um vetor. Vai armazendo quantas vezes cada nó é chamado! Para a média nodal. Deixei 1 de bobeira.
    #
