...
def length_correction_for_expansions(smaller_diameter, larger_diameter):
    """ 
    This function returns the acoustic length correction due to expansion in the acoustic domain. 
    This discontinuity is characterized by two elements in line with different diameters.
...
def length_correction_for_branches(branch_diameter, principal_diameter):
    """ 
    This function returns the acoustic length correction due to sidebranch in the acoustic domain. 
    This discontinuity is characterized by three elements, two with the same diameters in line, and 
    the other with different diameter connected to these two.
