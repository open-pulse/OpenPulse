...
class VolumeVelocityInput(QDialog):
    ...
    def load_table(self):
        ...
        self.volume_velocity_table_name = os.path.basename(self.path_imported_table)
        self.lineEdit_load_table_path.setText(self.path_imported_table)
        
        if "\\" in self.project_path:
            self.new_load_path_table = "{}\\{}".format(self.project_path, self.volume_velocity_table_name)
