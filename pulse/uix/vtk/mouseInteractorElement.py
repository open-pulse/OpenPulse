...
class MouseInteractorElement(vtk.vtkInteractorStyleTrackballCamera):
    ...
    def __init__(self, parent=None):
        ...
        self.listSelectedElements = []
        self.lastSelectedElementsProperty = []
    ...
    def rightButtonReleaseEvent(self, obj, event):
        ...
        for i in range(len(self.lastSelectedElementsProperty)):
            self.lastSelectedActors[i].GetMapper().ScalarVisibilityOn()
            self.lastSelectedActors[i].GetProperty().DeepCopy(self.lastSelectedElementsProperty[i])
        ...
        for actor in pickedActors:
            ...
            self.lastSelectedElementsProperty.append(current_actor_property)
            ...
            self.listSelectedElements.append(self.parent.actors_elements[actor])
        self.parent.update()
