...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_file_path.setMinimumSize(QSize(300, 28))
        self.lineEdit_file_path.setMaximumSize(QSize(16777215, 28))
        font1 = QFont()
        font1.setPointSize(8)
        self.lineEdit_file_path.setFont(font1)
        self.lineEdit_file_path.setAlignment(Qt.AlignCenter)

        self.gridLayout_4.addWidget(self.lineEdit_file_path, 0, 0, 1, 1)

        self.pushButton_search = QPushButton(self.frame_3)
        self.pushButton_search.setObjectName(u"pushButton_search")
        self.pushButton_search.setMinimumSize(QSize(80, 28))
        self.pushButton_search.setMaximumSize(QSize(80, 28))
        font2 = QFont()
        ...
        self.label_sheet_name.setMaximumSize(QSize(100, 28))
        self.label_sheet_name.setFont(font2)
        self.label_sheet_name.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.comboBox_sheet_names.setMinimumSize(QSize(100, 28))
        self.comboBox_sheet_names.setMaximumSize(QSize(200, 28))
        ...
        self.pushButton_exit.setMinimumSize(QSize(90, 28))
        self.pushButton_exit.setMaximumSize(QSize(90, 28))
        ...
        self.pushButton_confirm.setMinimumSize(QSize(90, 28))
        self.pushButton_confirm.setMaximumSize(QSize(90, 28))
