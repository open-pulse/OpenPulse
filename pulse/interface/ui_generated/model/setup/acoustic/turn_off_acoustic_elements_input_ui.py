...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox_action_selector = QComboBox(self.frame_correction_type)
        self.comboBox_action_selector.addItem("")
        self.comboBox_action_selector.addItem("")
        self.comboBox_action_selector.setObjectName(u"comboBox_action_selector")
        self.comboBox_action_selector.setMinimumSize(QSize(100, 26))
        self.comboBox_action_selector.setMaximumSize(QSize(100, 26))

        self.gridLayout.addWidget(self.comboBox_action_selector, 0, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.frame_correction_type, 1, 0, 1, 1)

        self.frame_confirm = QFrame(self.tab_setup)
        self.frame_confirm.setObjectName(u"frame_confirm")
        self.frame_confirm.setMinimumSize(QSize(0, 60))
        self.frame_confirm.setMaximumSize(QSize(16777215, 60))
        ...
        self.gridLayout_6.addWidget(self.frame_confirm, 3, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Turn-off acoustic elements", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"Turn-off acoustic elements setup", None))
        self.lineEdit_element_id.setText("")
        self.label_selection.setText(QCoreApplication.translate("Dialog", u"Elements IDs:", None))
        self.comboBox_action_selector.setItemText(0, QCoreApplication.translate("Dialog", u" Turn-off", None))
        self.comboBox_action_selector.setItemText(1, QCoreApplication.translate("Dialog", u" Turn-on", None))

#if QT_CONFIG(tooltip)
        self.comboBox_action_selector.setToolTip(QCoreApplication.translate("Dialog", u"<html><head/><body><p>Select the element length correction type</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Action:", None))
...
class TurnOffAcousticElementsInput_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
                                ...
                                - tab_setup: QWidget
                                    - (Layout): QGridLayout
                                            - frame_correction_type: QFrame
                                                - (Layout): QGridLayout
                                                        - comboBox_action_selector: QComboBox
                                                        - label_2: QLabel
