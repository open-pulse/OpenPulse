...
################################################################################
## Form generated from reading UI file 'specific_impedance_input.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        QWidget.setTabOrder(self.lineEdit_imag_value, self.pushButton_exit)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Specific impedance setup", None))
#if QT_CONFIG(whatsthis)
        Dialog.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.label_title.setText(QCoreApplication.translate("Dialog", u"Specific impedance setup", None))
        ...
        self.label_21.setText(QCoreApplication.translate("Dialog", u"[kg/m\u00b2s]", None))
...
class SpecificImpedanceInput_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
