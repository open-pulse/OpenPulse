...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, -464, 476, 876))
        ...
        self.pushButton_process_fluctuating_volume.setFont(font2)
        ...
        self.pushButton_plot_fluctuating_volume.setFont(font2)
        ...
        self.pushButton_pulsation_damper_calculator.setFont(font2)
        ...
        self.frame_all_parameters.setFrameShape(QFrame.NoFrame)
        self.frame_all_parameters.setFrameShadow(QFrame.Raised)
        ...
        self.comboBox_cylinder_acting.setFont(font5)
        ...
        self.lineEdit_stroke.setFont(font5)
        self.lineEdit_stroke.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_stroke.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_rotational_speed.setMinimumSize(QSize(110, 28))
        self.lineEdit_rotational_speed.setMaximumSize(QSize(140, 28))
        self.lineEdit_rotational_speed.setFont(font5)
        self.lineEdit_rotational_speed.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_rotational_speed.setAlignment(Qt.AlignCenter)

        self.gridLayout_14.addWidget(self.lineEdit_rotational_speed, 14, 2, 1, 1)
        ...
        self.spinBox_number_of_cylinders.setFont(font5)
        self.spinBox_number_of_cylinders.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_clearance_head_end.setMinimumSize(QSize(110, 28))
        self.lineEdit_clearance_head_end.setMaximumSize(QSize(140, 28))
        self.lineEdit_clearance_head_end.setFont(font5)
        self.lineEdit_clearance_head_end.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_clearance_head_end.setAlignment(Qt.AlignCenter)

        self.gridLayout_14.addWidget(self.lineEdit_clearance_head_end, 10, 2, 1, 1)
        ...
        self.lineEdit_bore_diameter.setFont(font5)
        self.lineEdit_bore_diameter.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_rod_diameter.setFont(font5)
        self.lineEdit_rod_diameter.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_rod_diameter.setAlignment(Qt.AlignCenter)
        ...
        self.spinBox_tdc1_crank_angle.setMinimumSize(QSize(0, 28))
        self.spinBox_tdc1_crank_angle.setMaximumSize(QSize(140, 28))
        self.spinBox_tdc1_crank_angle.setFont(font5)
        self.spinBox_tdc1_crank_angle.setAlignment(Qt.AlignCenter)
        self.spinBox_tdc1_crank_angle.setMaximum(270)
        self.spinBox_tdc1_crank_angle.setSingleStep(1)

        self.gridLayout_14.addWidget(self.spinBox_tdc1_crank_angle, 13, 2, 1, 1)
        ...
        self.lineEdit_clearance_crank_end.setMinimumSize(QSize(110, 28))
        self.lineEdit_clearance_crank_end.setMaximumSize(QSize(140, 28))
        self.lineEdit_clearance_crank_end.setFont(font5)
        self.lineEdit_clearance_crank_end.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_clearance_crank_end.setAlignment(Qt.AlignCenter)

        self.gridLayout_14.addWidget(self.lineEdit_clearance_crank_end, 11, 2, 1, 1)
        ...
        self.lineEdit_connecting_rod_length.setFont(font5)
        self.lineEdit_connecting_rod_length.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_connecting_rod_length.setAlignment(Qt.AlignCenter)
        ...
        self.comboBox_connection_type.setFont(font5)
        ...
        self.label_isentropic_exp.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_18.addWidget(self.label_isentropic_exp, 3, 1, 1, 1)
        ...
        self.label_fluctuating_volume_unit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout_18.addWidget(self.label_fluctuating_volume_unit, 10, 3, 1, 1)

        self.comboBox_fluid_data_source = QComboBox(self.frame_5)
        ...
        self.comboBox_fluid_data_source.setFont(font5)

        self.gridLayout_18.addWidget(self.comboBox_fluid_data_source, 1, 2, 1, 1)
        ...
        self.lineEdit_fluctuating_volume.setFont(font5)
        self.lineEdit_fluctuating_volume.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_fluctuating_volume.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.lineEdit_fluctuating_volume, 10, 2, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.label_59, 8, 1, 1, 1)
        ...
        self.label_suction_pressure_unit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout_18.addWidget(self.label_suction_pressure_unit, 5, 3, 1, 1)
        ...
        self.comboBox_temperature_units.setFont(font5)

        self.gridLayout_18.addWidget(self.comboBox_temperature_units, 7, 2, 1, 1)
        ...
        self.lineEdit_discharge_pressure.setFont(font5)
        self.lineEdit_discharge_pressure.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_discharge_pressure.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.lineEdit_discharge_pressure, 6, 2, 1, 1)
        ...
        self.lineEdit_suction_temperature.setFont(font5)
        self.lineEdit_suction_temperature.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_suction_temperature.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.lineEdit_suction_temperature, 8, 2, 1, 1)
        ...
        self.lineEdit_bulk_modulus.setFont(font5)
        self.lineEdit_bulk_modulus.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_bulk_modulus.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.lineEdit_bulk_modulus, 3, 2, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.label_61, 7, 1, 1, 1)
        ...
        self.label_discharge_temperature_unit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout_18.addWidget(self.label_discharge_temperature_unit, 9, 3, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.label_57, 6, 1, 1, 1)
        ...
        self.label_suction_temperature_unit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout_18.addWidget(self.label_suction_temperature_unit, 8, 3, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.label_17, 10, 1, 1, 1)
        ...
        self.label_bulk_modulus_unit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout_18.addWidget(self.label_bulk_modulus_unit, 3, 3, 1, 1)
        ...
        self.comboBox_pressure_units.setFont(font5)

        self.gridLayout_18.addWidget(self.comboBox_pressure_units, 4, 2, 1, 1)
        ...
        self.lineEdit_suction_pressure.setFont(font5)
        self.lineEdit_suction_pressure.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_suction_pressure.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.lineEdit_suction_pressure, 5, 2, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.label_60, 9, 1, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.label_58, 5, 1, 1, 1)

        self.horizontalSpacer_14 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_18.addItem(self.horizontalSpacer_14, 2, 0, 1, 1)
        ...
        self.lineEdit_discharge_temperature.setFont(font5)
        self.lineEdit_discharge_temperature.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_discharge_temperature.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.lineEdit_discharge_temperature, 9, 2, 1, 1)
        ...
        self.label_discharge_pressure_unit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout_18.addWidget(self.label_discharge_pressure_unit, 6, 3, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.label_62, 4, 1, 1, 1)

        self.horizontalSpacer_13 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_18.addItem(self.horizontalSpacer_13, 2, 4, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.pushButton_get_fluid, 2, 3, 1, 1)
        ...
        self.label_selected_fluid.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_18.addWidget(self.label_selected_fluid, 2, 1, 1, 1)

        self.label_fluid_data_source = QLabel(self.frame_5)
        self.label_fluid_data_source.setObjectName(u"label_fluid_data_source")
        self.label_fluid_data_source.setMinimumSize(QSize(0, 28))
        self.label_fluid_data_source.setMaximumSize(QSize(16777215, 28))
        self.label_fluid_data_source.setFont(font4)
        self.label_fluid_data_source.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_18.addWidget(self.label_fluid_data_source, 1, 1, 1, 1)
        ...
        self.comboBox_frequency_resolution.setFont(font5)
        self.comboBox_frequency_resolution.setLayoutDirection(Qt.LeftToRight)
        ...
        self.spinBox_max_frequency.setFont(font5)
        self.spinBox_max_frequency.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_number_of_revolutions.setFont(font5)
        self.lineEdit_number_of_revolutions.setStyleSheet(u"")
        self.lineEdit_number_of_revolutions.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_frequency_resolution.setFont(font5)
        ...
        self.pushButton_process_aquisition_parameters.setFont(font5)
        ...
        self.spinBox_number_of_points.setFont(font5)
        self.spinBox_number_of_points.setAlignment(Qt.AlignCenter)
        ...
        self.pushButton_plot_volumetric_flow_rate_at_discharge_time.setFont(font5)
        ...
        self.pushButton_plot_volumetric_flow_rate_at_suction_time.setFont(font5)
        ...
        self.pushButton_plot_piston_position_and_velocity_time.setFont(font5)
        ...
        self.pushButton_plot_rod_pressure_load_time.setFont(font5)
        ...
        self.pushButton_plot_pressure_head_end_angle.setFont(font5)
        ...
        self.pushButton_plot_volume_head_end_angle.setFont(font5)
        ...
        self.pushButton_plot_pressure_crank_end_angle.setFont(font5)
        ...
        self.pushButton_plot_volume_crank_end_angle.setFont(font5)
        ...
        self.pushButton_plot_volumetric_flow_rate_at_discharge_frequency.setFont(font5)
        ...
        self.pushButton_plot_volumetric_flow_rate_at_suction_frequency.setFont(font5)
        ...
        self.pushButton_plot_rod_pressure_load_frequency.setFont(font5)
        ...
        self.pushButton_plot_PV_diagram_both_ends.setFont(font5)
        ...
        self.pushButton_plot_PV_diagram_crank_end.setFont(font5)
        ...
        self.pushButton_plot_PV_diagram_head_end.setFont(font5)
        ...
        self.frame_remove_selection.setFrameShape(QFrame.NoFrame)
        self.frame_remove_selection.setFrameShadow(QFrame.Raised)
        ...
        self.treeWidget_nodal_info.setFont(font8)
        self.treeWidget_nodal_info.setFrameShape(QFrame.StyledPanel)
        self.treeWidget_nodal_info.setFrameShadow(QFrame.Sunken)
        ...
        self.frame_remove_buttons.setFrameShape(QFrame.NoFrame)
        self.frame_remove_buttons.setFrameShadow(QFrame.Raised)
        ...
        self.lineEdit_selected_node_id.setFocusPolicy(Qt.ClickFocus)
        self.lineEdit_selected_node_id.setStyleSheet(u"")
        self.lineEdit_selected_node_id.setAlignment(Qt.AlignCenter)
        ...
        QWidget.setTabOrder(self.lineEdit_rod_diameter, self.lineEdit_clearance_head_end)
        ...
        QWidget.setTabOrder(self.spinBox_tdc1_crank_angle, self.lineEdit_rotational_speed)
        QWidget.setTabOrder(self.lineEdit_rotational_speed, self.pushButton_exit)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_rotational_speed.setText(QCoreApplication.translate("Dialog", u"178", None))
        ...
        self.lineEdit_clearance_head_end.setText(QCoreApplication.translate("Dialog", u"15", None))
        ...
        self.lineEdit_clearance_crank_end.setText(QCoreApplication.translate("Dialog", u"18", None))
        ...
        self.label_fluid_data_source.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p align=\"right\">Fluid data source:</p></body></html>", None))
                                                                ...
                                                                - (Layout): QGridLayout
                                                                        ...
                                                                        - frame_5: QFrame
                                                                            - (Layout): QGridLayout
                                                                                    ...
                                                                                    - label_fluid_data_source: QLabel
