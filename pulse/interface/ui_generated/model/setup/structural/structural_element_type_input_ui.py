...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMinimumSize(QSize(440, 460))
        Dialog.setMaximumSize(QSize(440, 460))
        ...
        self.label_attribute_to.setFont(font)
        ...
        self.frame_element_options.setFrameShape(QFrame.Shape.NoFrame)
        self.frame_element_options.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.label_capped_end.setFont(font)
        self.label_capped_end.setFrameShape(QFrame.Shape.NoFrame)
        self.label_capped_end.setFrameShadow(QFrame.Shadow.Sunken)
        self.label_capped_end.setMidLineWidth(0)
        self.label_capped_end.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)

        self.gridLayout_7.addWidget(self.label_capped_end, 3, 1, 1, 1)
        ...
        self.label_element_type.setFont(font)
        ...
        self.comboBox_capped_end.setFont(font)

        self.gridLayout_7.addWidget(self.comboBox_capped_end, 3, 2, 1, 1)
        ...
        self.comboBox_wall_formulation.setFont(font)

        self.gridLayout_7.addWidget(self.comboBox_wall_formulation, 1, 2, 1, 1)
        ...
        self.label_wall_formulation.setFrameShape(QFrame.Shape.NoFrame)
        self.label_wall_formulation.setFrameShadow(QFrame.Shadow.Sunken)
        self.label_wall_formulation.setMidLineWidth(0)
        self.label_wall_formulation.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)

        self.gridLayout_7.addWidget(self.label_wall_formulation, 1, 1, 1, 1)
        ...
        self.label_force_offset.setFont(font)
        self.label_force_offset.setFrameShape(QFrame.Shape.NoFrame)
        self.label_force_offset.setFrameShadow(QFrame.Shadow.Sunken)
        self.label_force_offset.setMidLineWidth(0)
        self.label_force_offset.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.comboBox_force_offset.setFont(font)
        ...
        self.gridLayout_10 = QGridLayout(self.tab_list)
        ...
        self.treeWidget_lines_info.setFont(font1)
        self.treeWidget_lines_info.setAlternatingRowColors(True)
        self.treeWidget_lines_info.setIndentation(0)

        self.gridLayout_10.addWidget(self.treeWidget_lines_info, 0, 0, 1, 1)
        ...
        QWidget.setTabOrder(self.comboBox_capped_end, self.pushButton_exit)
