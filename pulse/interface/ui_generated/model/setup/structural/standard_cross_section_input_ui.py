...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_pipe_material.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.label_units.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.label_pipe_material_2.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox_units.setItemText(1, QCoreApplication.translate("Dialog", u" milimeters", None))
