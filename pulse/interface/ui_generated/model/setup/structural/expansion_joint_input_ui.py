...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.frame_tabWidgets.setFrameShape(QFrame.Shape.Box)
        ...
        self.frame_top_inputs.setMaximumSize(QSize(16777215, 232))
        ...
        self.lineEdit_expansion_joint_name.setFont(font1)
        self.lineEdit_expansion_joint_name.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.lineEdit_expansion_joint_name.setClearButtonEnabled(True)
        ...
        self.lineEdit_joint_mass.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.label_selected_id_10.setFont(font1)
        ...
        self.lineEdit_effective_diameter.setFont(font1)
        self.lineEdit_effective_diameter.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.lineEdit_axial_locking_criteria.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.tabWidget_inputs.setFont(font1)
        ...
        self.pushButton_load_Kx_table = QPushButton(self.tab_tabular_values)
        ...
        self.gridLayout_10.addWidget(self.pushButton_load_Kx_table, 0, 3, 1, 1)
        ...
        self.lineEdit_Kyz_table_path.setMinimumSize(QSize(320, 30))
        self.lineEdit_Kyz_table_path.setMaximumSize(QSize(320, 30))
        ...
        self.gridLayout_10.addItem(self.horizontalSpacer_3, 0, 4, 1, 1)

        self.pushButton_load_Krx_table = QPushButton(self.tab_tabular_values)
        ...
        self.pushButton_load_Krx_table.setMinimumSize(QSize(40, 30))
        self.pushButton_load_Krx_table.setMaximumSize(QSize(40, 30))
        self.pushButton_load_Krx_table.setStyleSheet(u"")
        self.pushButton_load_Krx_table.setIcon(icon)
        self.pushButton_load_Krx_table.setIconSize(QSize(22, 22))

        self.gridLayout_10.addWidget(self.pushButton_load_Krx_table, 2, 3, 1, 1)
        ...
        self.lineEdit_Kx_table_path.setMinimumSize(QSize(320, 30))
        self.lineEdit_Kx_table_path.setMaximumSize(QSize(320, 30))
        self.lineEdit_Kx_table_path.setSizeIncrement(QSize(0, 0))
        self.lineEdit_Kx_table_path.setFont(font3)
        ...
        self.lineEdit_Krx_table_path.setMinimumSize(QSize(320, 30))
        self.lineEdit_Krx_table_path.setMaximumSize(QSize(320, 30))
        ...
        self.pushButton_load_Kryz_table = QPushButton(self.tab_tabular_values)
        ...
        self.pushButton_load_Kryz_table.setMinimumSize(QSize(40, 30))
        self.pushButton_load_Kryz_table.setMaximumSize(QSize(40, 30))
        self.pushButton_load_Kryz_table.setStyleSheet(u"")
        self.pushButton_load_Kryz_table.setIcon(icon)
        self.pushButton_load_Kryz_table.setIconSize(QSize(22, 22))

        self.gridLayout_10.addWidget(self.pushButton_load_Kryz_table, 3, 3, 1, 1)
        ...
        self.lineEdit_Kryz_table_path.setMinimumSize(QSize(320, 30))
        self.lineEdit_Kryz_table_path.setMaximumSize(QSize(320, 30))
        ...
        self.pushButton_load_Kyz_table = QPushButton(self.tab_tabular_values)
        ...
        self.pushButton_load_Kyz_table.setMinimumSize(QSize(40, 30))
        self.pushButton_load_Kyz_table.setMaximumSize(QSize(40, 30))
        self.pushButton_load_Kyz_table.setStyleSheet(u"")
        self.pushButton_load_Kyz_table.setIcon(icon)
        self.pushButton_load_Kyz_table.setIconSize(QSize(22, 22))

        self.gridLayout_10.addWidget(self.pushButton_load_Kyz_table, 1, 3, 1, 1)
        ...
        self.selection_frame = QFrame(self.frame_tabWidgets)
        ...
        self.lineEdit_selected_id.setFont(font7)
        self.lineEdit_selected_id.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        font8.setBold(False)
        self.label_selected_id.setFont(font8)
        ...
        self.gridLayout_30.addItem(self.horizontalSpacer_2, 0, 0, 1, 1)


        self.gridLayout_4.addWidget(self.selection_frame, 0, 0, 1, 1)
        ...
        QWidget.setTabOrder(self.pushButton_load_Kyz_table, self.lineEdit_Krx_table_path)
