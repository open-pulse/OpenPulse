...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 438, 378))
        ...
        self.label_selected_id_11.setMinimumSize(QSize(160, 28))
        ...
        self.label_flange_diameter_2.setMinimumSize(QSize(160, 28))
        ...
        self.label_flange_length.setMinimumSize(QSize(160, 28))
        ...
        self.label_flange_diameter.setMinimumSize(QSize(160, 28))
        ...
        self.label_selected_id_14.setMinimumSize(QSize(160, 28))
        ...
        self.label_selected_id_13.setMinimumSize(QSize(160, 28))
        ...
        self.label_valve_internal_length.setMinimumSize(QSize(160, 28))
        ...
        self.label_selected_id_12.setMinimumSize(QSize(160, 28))
        ...
        self.label_flange_diameter_3.setMinimumSize(QSize(160, 28))
        ...
        self.lineEdit_valve_wall_thickness.setMinimumSize(QSize(132, 28))
        self.lineEdit_valve_wall_thickness.setMaximumSize(QSize(300, 28))
        ...
        self.lineEdit_valve_effective_diameter.setMinimumSize(QSize(132, 28))
        self.lineEdit_valve_effective_diameter.setMaximumSize(QSize(300, 28))
        ...
        self.label_selected_id_10.setMinimumSize(QSize(160, 28))
        ...
        QWidget.setTabOrder(self.lineEdit_valve_wall_thickness, self.lineEdit_stiffening_factor)
