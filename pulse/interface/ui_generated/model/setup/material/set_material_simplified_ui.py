...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_selected_name.setFocusPolicy(Qt.FocusPolicy.ClickFocus)
        self.lineEdit_selected_name.setStyleSheet(u"")
        self.lineEdit_selected_name.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.lineEdit_identifier.setFocusPolicy(Qt.FocusPolicy.ClickFocus)
        self.lineEdit_identifier.setStyleSheet(u"")
        self.lineEdit_identifier.setAlignment(Qt.AlignmentFlag.AlignCenter)
