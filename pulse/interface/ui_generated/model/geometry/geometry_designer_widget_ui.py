...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 458, 750))
        ...
        self.frame_general_options.setFrameShape(QFrame.NoFrame)
        self.frame_general_options.setFrameShadow(QFrame.Raised)
        ...
        self.structure_type_label_2.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.structure_type_label.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.structure_type_label_3.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.general_options_label.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy.setHeightForWidth(self.structure_combobox.sizePolicy().hasHeightForWidth())
        self.structure_combobox.setSizePolicy(sizePolicy)
        ...
        self.create_structure_frame.setFrameShape(QFrame.Box)
        self.create_structure_frame.setFrameShadow(QFrame.Plain)
        ...
        self.remove_attach_add_frame.setFrameShape(QFrame.NoFrame)
        self.remove_attach_add_frame.setFrameShadow(QFrame.Raised)
        ...
        self.frame_bending_options.setFrameShape(QFrame.NoFrame)
        self.frame_bending_options.setFrameShadow(QFrame.Raised)
        ...
        self.bending_radius_label.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.bending_options_label.setAlignment(Qt.AlignCenter)
        ...
        self.bending_radius_line_edit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.bending_type_label.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.frame_bounding_box_sizes.setFrameShape(QFrame.NoFrame)
        self.frame_bounding_box_sizes.setFrameShadow(QFrame.Raised)
        ...
        sizePolicy1.setHeightForWidth(self.y_line_edit.sizePolicy().hasHeightForWidth())
        self.y_line_edit.setSizePolicy(sizePolicy1)
        self.y_line_edit.setMinimumSize(QSize(160, 26))
        self.y_line_edit.setMaximumSize(QSize(160, 26))
        self.y_line_edit.setFont(font)
        self.y_line_edit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.y_line_edit.setClearButtonEnabled(True)

        self.gridLayout_10.addWidget(self.y_line_edit, 2, 2, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.unity_y_label, 2, 3, 1, 1)
        ...
        self.dy_label.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_10.addWidget(self.dy_label, 2, 1, 1, 1)
        ...
        self.dz_label.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_10.addWidget(self.dz_label, 3, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.unity_x_label, 1, 3, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.unity_z_label, 3, 3, 1, 1)
        ...
        self.dx_label.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_10.addWidget(self.dx_label, 1, 1, 1, 1)

        self.horizontalSpacer_15 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_10.addItem(self.horizontalSpacer_15, 1, 4, 1, 1)
        ...
        self.sizes_coords_label.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy1.setHeightForWidth(self.z_line_edit.sizePolicy().hasHeightForWidth())
        self.z_line_edit.setSizePolicy(sizePolicy1)
        self.z_line_edit.setMinimumSize(QSize(160, 26))
        self.z_line_edit.setMaximumSize(QSize(160, 26))
        self.z_line_edit.setFont(font)
        self.z_line_edit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.z_line_edit.setClearButtonEnabled(True)

        self.gridLayout_10.addWidget(self.z_line_edit, 3, 2, 1, 1)

        self.x_line_edit = QLineEdit(self.frame_bounding_box_sizes)
        self.x_line_edit.setObjectName(u"x_line_edit")
        sizePolicy1.setHeightForWidth(self.x_line_edit.sizePolicy().hasHeightForWidth())
        self.x_line_edit.setSizePolicy(sizePolicy1)
        self.x_line_edit.setMinimumSize(QSize(160, 26))
        self.x_line_edit.setMaximumSize(QSize(160, 26))
        self.x_line_edit.setFont(font)
        self.x_line_edit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.x_line_edit.setClearButtonEnabled(True)

        self.gridLayout_10.addWidget(self.x_line_edit, 1, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.create_structure_frame, 2, 0, 1, 1)
        ...
        self.frame_division_options.setFrameShape(QFrame.Box)
        self.frame_division_options.setFrameShadow(QFrame.Plain)
        ...
        sizePolicy2.setHeightForWidth(self.options_stack_widget.sizePolicy().hasHeightForWidth())
        self.options_stack_widget.setSizePolicy(sizePolicy2)
        ...
        self.position_slider_label.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.division_slider_label.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.division_slider.setOrientation(Qt.Horizontal)
        ...
        self.division_amount_spinbox.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy1.setHeightForWidth(self.selected_point_combo_box.sizePolicy().hasHeightForWidth())
        self.selected_point_combo_box.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.distance_axis_combo_box.sizePolicy().hasHeightForWidth())
        self.distance_axis_combo_box.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.distance_value_line_edit.sizePolicy().hasHeightForWidth())
        self.distance_value_line_edit.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.division_combobox.sizePolicy().hasHeightForWidth())
        self.division_combobox.setSizePolicy(sizePolicy1)
        ...
        self.general_options_label_3.setAlignment(Qt.AlignCenter)
        ...
        self.gridLayout_4.addWidget(self.frame_division_options, 8, 0, 1, 1)
        ...
        QWidget.setTabOrder(self.bending_radius_line_edit, self.x_line_edit)
        QWidget.setTabOrder(self.x_line_edit, self.y_line_edit)
        QWidget.setTabOrder(self.y_line_edit, self.z_line_edit)
        QWidget.setTabOrder(self.z_line_edit, self.frame)
        QWidget.setTabOrder(self.frame, self.delete_button)
        QWidget.setTabOrder(self.delete_button, self.attach_button)
        QWidget.setTabOrder(self.attach_button, self.add_button)
        QWidget.setTabOrder(self.add_button, self.division_slider)
        QWidget.setTabOrder(self.division_slider, self.division_amount_spinbox)
        QWidget.setTabOrder(self.division_amount_spinbox, self.cancel_button)
