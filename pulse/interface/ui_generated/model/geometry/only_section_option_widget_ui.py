...
################################################################################
## Form generated from reading UI file 'only_section_option_widget.ui'
##
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.set_section_button.setText(QCoreApplication.translate("Form", u"Set Configuration", None))
        self.set_section_button.setProperty(u"status", QCoreApplication.translate("Form", u"danger", None))
    # retranslateUi



class OnlySectionOptionWidget_UI(QWidget, Ui_Form):
    """
    Component Hierarchy:
    - Form: QWidget
        - (Layout): QVBoxLayout
