...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_reaction_mz.setFont(font)
        self.lineEdit_reaction_mz.setStyleSheet(u"")
        self.lineEdit_reaction_mz.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_reaction_fz.setFont(font)
        self.lineEdit_reaction_fz.setStyleSheet(u"")
        self.lineEdit_reaction_fz.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_reaction_fx.setFont(font)
        self.lineEdit_reaction_fx.setStyleSheet(u"")
        self.lineEdit_reaction_fx.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_reaction_mx.setFont(font)
        self.lineEdit_reaction_mx.setStyleSheet(u"")
        self.lineEdit_reaction_mx.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_reaction_my.setFont(font)
        self.lineEdit_reaction_my.setStyleSheet(u"")
        self.lineEdit_reaction_my.setAlignment(Qt.AlignCenter)
        ...
        self.lineEdit_reaction_fy.setFont(font)
        self.lineEdit_reaction_fy.setStyleSheet(u"")
        self.lineEdit_reaction_fy.setAlignment(Qt.AlignCenter)

        self.gridLayout_2.addWidget(self.lineEdit_reaction_fy, 1, 2, 1, 1)


        self.gridLayout_3.addWidget(self.frame_responses, 2, 0, 1, 1)
        ...
        self.frame_treeWidgets = QFrame(Form)
        ...
        self.frame_treeWidgets.setFrameShape(QFrame.Box)
        self.frame_treeWidgets.setFrameShadow(QFrame.Raised)
        ...
        self.lineEdit_node_id.setFont(font4)
        ...
        self.treeWidget_reactions_at_constrained_dofs.setFont(font6)
        ...
        self.tabWidget_springs_dampers.setFont(font3)
        ...
        self.treeWidget_reactions_at_springs.setFont(font7)
        ...
        self.treeWidget_reactions_at_dampers.setFont(font8)
        ...
        self.gridLayout_3.addWidget(self.frame_treeWidgets, 1, 0, 1, 1)
