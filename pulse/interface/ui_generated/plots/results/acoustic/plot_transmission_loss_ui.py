...
#if QT_CONFIG(tooltip)
        self.lineEdit_cutoff_frequency.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"center\">f<span style=\" vertical-align:sub;\">c</span> = 1.8412 x C<span style=\" vertical-align:sub;\">o </span>/ (\u03c0 * D<span style=\" vertical-align:sub;\">in</span>), </p><p align=\"justify\">where the C<span style=\" vertical-align:sub;\">0</span> is the speed of sound in m/s and D<span style=\" vertical-align:sub;\">in</span> is the internal diameter in m.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
