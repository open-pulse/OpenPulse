...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_13.setContentsMargins(0, 8, 0, 6)
        ...
        self.comboBox_colormaps.setMinimumSize(QSize(180, 26))
        ...
        self.comboBox_color_scale = QComboBox(self.frame_4)
        ...
        self.comboBox_color_scale.setMinimumSize(QSize(180, 26))
