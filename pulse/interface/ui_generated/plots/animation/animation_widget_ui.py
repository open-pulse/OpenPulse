...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_frames.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.label_cycles.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.frame_slider.setFrameShape(QFrame.NoFrame)
        self.frame_slider.setFrameShadow(QFrame.Raised)
        ...
        self.frame_phase_label.setFrameShape(QFrame.NoFrame)
        self.frame_phase_label.setFrameShadow(QFrame.Raised)
        ...
        self.phase_slider.setOrientation(Qt.Horizontal)
        ...
        self.pushButton_animate.setMaximumSize(QSize(100, 28))
        ...
        self.pushButton_export.setMaximumSize(QSize(100, 28))
