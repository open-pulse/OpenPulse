...
################################################################################
## Form generated from reading UI file 'print_message.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 284, 82))
        ...
        self.frame_progress_bar = QFrame(Dialog)
...
"QProgressBar::chunk {border-radius: 4px;   background-color:  rgb(20,150,255);  border-width: 1px }")
        ...
        QWidget.setTabOrder(self.scrollArea, self.pushButton_close)
...
class PrintMessage_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
