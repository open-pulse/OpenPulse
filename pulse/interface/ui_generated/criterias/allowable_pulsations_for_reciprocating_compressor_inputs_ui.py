...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 374, 436))
        self.gridLayout_5 = QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout_5.setObjectName(u"gridLayout_5")
        self.tabWidget = QTabWidget(self.scrollAreaWidgetContents)
        self.tabWidget.setObjectName(u"tabWidget")
        self.tabWidget.setMinimumSize(QSize(0, 80))
        self.tab_cylinder_flange = QWidget()
        self.tab_cylinder_flange.setObjectName(u"tab_cylinder_flange")
        self.gridLayout_13 = QGridLayout(self.tab_cylinder_flange)
        self.gridLayout_13.setObjectName(u"gridLayout_13")
        self.frame_3 = QFrame(self.tab_cylinder_flange)
        self.frame_3.setObjectName(u"frame_3")
        self.frame_3.setMinimumSize(QSize(0, 240))
        ...
        font1.setBold(False)
        self.label_first_criteria.setFont(font1)
        ...
        self.lineEdit_compressor_node_id.setFont(font2)
        ...
        self.lineEdit_unfiltered_criteria.setFont(font2)
        ...
        self.lineEdit_pressure_ratio.setFont(font2)
        ...
        self.pushButton_plot_unfiltered_criteria.setFont(font3)
        ...
        self.tabWidget.addTab(self.tab_cylinder_flange, "")
        self.tab_line_side = QWidget()
        self.tab_line_side.setObjectName(u"tab_line_side")
        self.gridLayout_3 = QGridLayout(self.tab_line_side)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.frame_14 = QFrame(self.tab_line_side)
        ...
        self.pushButton_plot_filtered_criteria.setFont(font3)
        ...
        self.gridLayout_9.addWidget(self.frame_15, 2, 0, 1, 1)
        ...
        self.label_second_criteria.setFont(font1)
        ...
        self.lineEdit_nozzle_id.setFont(font2)
        ...
        self.lineEdit_line_pressure.setFont(font2)
        ...
        self.lineEdit_internal_diameter.setFont(font2)
        ...
        self.lineEdit_speed_of_sound.setFont(font2)
        ...
        self.frame_19.setMinimumSize(QSize(0, 44))
        ...
        self.checkBox_prestudy_analysis.setMinimumSize(QSize(0, 0))
        self.checkBox_prestudy_analysis.setFont(font2)
        ...
        self.tabWidget.addTab(self.tab_line_side, "")
    ...
    def retranslateUi(self, Form):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_cylinder_flange), QCoreApplication.translate("Form", u"Cylinder flange", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_line_side), QCoreApplication.translate("Form", u"Line-side", None))
    # retranslateUi
