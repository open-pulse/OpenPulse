...
################################################################################
## Form generated from reading UI file 'modal_analysis.ui'
##
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_title.setText(QCoreApplication.translate("Dialog", u"Acoustic modal analysis", None))
...
class ModalAnalysis_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
