...
################################################################################
## Form generated from reading UI file 'harmonic_analysis_mode_superposition_method.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMaximumSize(QSize(380, 360))
        ...
        self.frame_7.setMinimumSize(QSize(360, 36))
        self.frame_7.setMaximumSize(QSize(360, 36))
        ...
        self.lineEdit_modes = QLineEdit(self.frame_7)
        self.lineEdit_modes.setObjectName(u"lineEdit_modes")
        self.lineEdit_modes.setMinimumSize(QSize(100, 28))
        self.lineEdit_modes.setMaximumSize(QSize(100, 28))
        self.lineEdit_modes.setFont(font1)
        self.lineEdit_modes.setStyleSheet(u"")
        self.lineEdit_modes.setAlignment(Qt.AlignCenter)

        self.gridLayout_8.addWidget(self.lineEdit_modes, 0, 2, 1, 1)
        ...
        self.enter_setup_button.setFont(font1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_subtitle.setText(QCoreApplication.translate("Dialog", u"Mode superposition method", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Modes to expand:", None))
...
class HarmonicAnalysisModeSuperpositionMethod_UI(QDialog, Ui_Dialog):
    """
    Component Hierarchy:
    - Dialog: QDialog
        - (Layout): QGridLayout
