...
class StatusBar(QStatusBar):
    ...
    def update_geometry_information(self):
        points, curves = app().main_window.project.preprocessor.get_geometry_statistics()
    ...
    def update_mesh_information(self):
        nodes, acoustic_elements, structural_elements = app().main_window.project.preprocessor.get_mesh_statistics()
