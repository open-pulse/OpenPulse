...
from pulse.interface.user_input.model.criteria.allowable_pulsations_for_reciprocating_compressor_inputs import AllowablePulsationsForReciprocatingCompressorInputs
...
class InputUi:
    ...
    def plot_structural_frequency_response(self):
        if app().project.analysis_id in [
            ...
            if self.project.model.structural_solution is None:
                return None
    ...
    def plot_acoustic_frequency_response(self):
        if app().project.analysis_id in [
            ...
            if self.project.model.acoustic_solution is None:
                return None
    ...
    def allowable_pulsations_for_reciprocating_compressor(self):
