...
from pulse.interface.user_input.model.editor.pulsation_attenuator_device_input import PulsationAttenuatorDeviceInput
...
class InputUi:
    ...
    def pulsation_attenuator_device_editor(self):
        self.process_input(PulsationAttenuatorDeviceInput)
