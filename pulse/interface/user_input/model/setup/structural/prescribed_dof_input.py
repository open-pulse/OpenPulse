...
from pulse.interface.ui_generated.model.setup.structural.prescribed_dof_input_ui import PrescribedDofInput_UI
...
class PrescribedDofInput(PrescribedDofInput_UI):
