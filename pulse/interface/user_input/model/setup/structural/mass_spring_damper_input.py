...
class MassSpringDamperInput(MassSpringDamperInput_UI, StructuralNodesInput):
    ...
    def load_Jx_table(self):
        self.Jx_table_values, self.Jx_table_path = self.load_table(
            self.lineEdit_path_table_Jx, "Jx"
        )
    ...
    def load_Jy_table(self):
        self.Jy_table_values, self.Jy_table_path = self.load_table(
            self.lineEdit_path_table_Jy, "Jy"
        )
    ...
    def load_Jz_table(self):
        self.Jz_table_values, self.Jz_table_path = self.load_table(
            self.lineEdit_path_table_Jz, "Jz"
        )
    ...
    def check_table_values_lumped_masses(self, node_ids: list):
        ...
        if self.Jx_table_path is None:
            self.Jx_table_values, self.Jx_table_path = self.load_table(
                self.lineEdit_path_table_Jx, "Jx", direct_load=True
            )

        if self.Jy_table_path is None:
            self.Jy_table_values, self.Jy_table_path = self.load_table(
                self.lineEdit_path_table_Jy, "Jy", direct_load=True
            )

        if self.Jz_table_path is None:
            self.Jz_table_values, self.Jz_table_path = self.load_table(
                self.lineEdit_path_table_Jz, "Jz", direct_load=True
            )
        ...
        for node_id in node_ids:
            ...
            if self.Jx_table_name is not None:
                self.Jx_table_name, self.Jx_array = self.save_tables_files(
                    "Jx", node_id, self.Jx_table_values
                )

            if self.Jy_table_name is not None:
                self.Jy_table_name, self.Jy_array = self.save_tables_files(
                    "Jy", node_id, self.Jy_table_values
                )

            if self.Jz_table_name is not None:
                self.Jz_table_name, self.Jz_array = self.save_tables_files(
                    "Jz", node_id, self.Jz_table_values
                )
            ...
            values = [
                ...
                self.Jx_table_values,
                self.Jy_table_values,
                self.Jz_table_values,
            ]
