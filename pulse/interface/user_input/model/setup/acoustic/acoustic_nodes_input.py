...
class AcousticNodesInput(NodesInput):
    ...
    def constant_values_attribution_callback(self, lineEdit_nodes: QLineEdit, lineEdit_real: QLineEdit, 
                                            lineEdit_imag: QLineEdit, input_name: str, properties: str | list[str],
                                            reset_camera=True):
        ...
        stop, value = self.check_complex_entries(lineEdit_real, lineEdit_imag, input_name)
    ...
    def table_values_attribution_callback(self, lineEdit_nodes: QLineEdit, lineEdit_table_path: QLineEdit, 
                                            input_name: str, properties: str | list[str],
                                            reset_camera=True):
